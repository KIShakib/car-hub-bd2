...
const Checkout = () => {
    ...
    return (
        <div>
            <div className="hero h-80 w-2/3 mx-auto" style={{ backgroundImage: `url(${img})` }}>
            ...
            <div class="w-2/3 my-20 mx-auto">
                ...
                <form className='border-2 p-2'>
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6">
                        ...
                        <textarea className="textarea textarea-bordered rounded-none col-span-2" placeholder="Messages..."></textarea>
                    </div>
                    <button className='btn btn-outline btn-accent rounded-none my-10'>Place Order</button>
                </form>

                <p class="mt-5">Check out the original floating label form elements on <Link to="/" class="text-blue-600 hover:underline">Car Hub BD</Link> and browse other similar components built with Tailwind CSS.
                </p>
            </div>
        </div>
    );
